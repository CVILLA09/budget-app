...
<img width="374" alt="erd_diagram" src="https://raw.githubusercontent.com/microverseinc/curriculum-rails/main/capstone/images/erd_diagram.png?token=GHSAT0AAAAAACJMABZNMIA6H5DJLESC3OCGZLLTNQA">
...
```sh
  cd my-folder
  git clone git@github.com:CVILLA09/budget-app.git
```
